...
/// initAudioBackground()/detachedServices() and never touches dart:io,
/// path_provider, or drift's web options itself — native platforms resolve
/// to the IO wiring, the web build to web-safe wiring (drift-on-wasm, no
/// isolates, no ffmpeg, no Directory.systemTemp).
///
/// Both sides export the same six names; the web tier is honest about
